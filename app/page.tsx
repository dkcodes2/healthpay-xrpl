        ...
        <section className="py-20 md:py-32 bg-gradient-to-b from-white to-emerald-50 dark:from-gray-950 dark:to-gray-900">
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              ...
              <div className="relative h-[350px] w-full rounded-xl bg-gradient-to-r from-emerald-500 to-teal-400 p-6 text-white shadow-lg">
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-12 lg:grid-cols-2 items-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-emerald-100 dark:bg-emerald-900 p-6 rounded-lg">
                  <h3 className="text-2xl font-bold text-emerald-700 dark:text-emerald-300">Secure</h3>
                  <p className="text-gray-500 dark:text-gray-400">DID-based identity verification</p>
                </div>
                <div className="bg-emerald-100 dark:bg-emerald-900 p-6 rounded-lg">
                  <h3 className="text-2xl font-bold text-emerald-700 dark:text-emerald-300">Stable</h3>
                  <p className="text-gray-500 dark:text-gray-400">Value backed by RLUSD</p>
                </div>
              </div>
            </div>
          </div>
